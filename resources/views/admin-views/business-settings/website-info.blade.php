                    ...
                    <div class="col-md-8 col-xl-9">
                        @if ($businessSetting['maintenance_mode'])
                            <div class="d-flex flex-wrap gap-3 align-items-center">
                                ...
                                <a class="btn btn-outline-primary btn-sm edit square-btn maintenance-mode-show"
                    ...
                    <div class="row">
                                ...
                                <select name="language" class="form-control js-select2-custom">
                                    @if (isset($businessSetting['language']))
                                        @foreach (json_decode($businessSetting['language']) as $item)
                                            <option value="{{ $item->code }}" {{ $item->default == 1 ? 'selected' : '' }}>
                                                {{ ucwords($item->name) . ' (' . ucwords($item->code) . ')' }}</option>
                                        @endforeach
                                    @endif
                                </select>
                            </div>
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{ $businessSetting['shop_address'] }}" name="shop_address"
                                    class="form-control" id="shop-address"
                        ...
                        @if (getWebConfig('map_api_status') == 1)
                            <div class="col-sm-6 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control latitude disabled-input" type="text" name="latitude"
                                        id="latitude" value="{{ $default_location['lat'] ?? '-33.8688' }}"
                            ...
                            <div class="col-sm-6 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control longitude disabled-input" type="text" name="longitude"
                                        id="longitude" value="{{ $default_location['lng'] ?? '151.2195' }}"
                ...
                <div class="card-body">
                    <div class="row align-items-end">
                        ...
                        <div class="col-sm-6 col-lg-4">
                            ...
                            <div class="form-control form-group d-flex gap-2">
                                <div class="custom-control custom-radio flex-grow-1">
                                    <input type="radio" class="custom-control-input" value="single"
                                        name="business_mode" id="single_vendor"
                                        {{ $businessSetting['business_mode'] == 'single' ? 'checked' : '' }}>
                                    <label class="custom-control-label"
                                        for="single_vendor">{{ translate('single_vendor') }}</label>
                                </div>
                                <div class="custom-control custom-radio flex-grow-1">
                                    <input type="radio" class="custom-control-input" value="multi"
                                        name="business_mode" id="multi_vendor"
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="form-group">
                                <label class="input-label text-capitalize">{{ translate('digit_after_decimal_point') }}
                    ...
                    <div class="row gy-3">
                        <div class="col-lg-6">
                            <div class="d-flex gap-2 align-items-center text-capitalize mb-3">
                                <img width="22"
                                    src="{{ dynamicAsset(path: 'public/assets/back-end/img/apple.png') }}"
                                    alt="">
                                ...
                                <div class="d-flex justify-content-between align-items-center gap-2 mb-2">
                                    ...
                                    <label class="switcher" for="app-store-download-status">
                                        <input type="checkbox" value="1"
                                            class="switcher_input toggle-switch-message" name="app_store_download_status"
                                            id="app-store-download-status"
                                            {{ $appStoreDownload['status'] == 1 ? 'checked' : '' }}
                                            data-modal-id="toggle-modal" data-toggle-id="app-store-download-status"
                            ...
                            <div class="bg-aliceblue p-3 rounded">
                                <div class="d-flex justify-content-between align-items-center gap-2 mb-2">
                                    ...
                                    <label class="switcher" for="play-store-download-status">
                                        <input type="checkbox" value="1"
                                            class="switcher_input toggle-switch-message" name="play_store_download_status"
                                            id="play-store-download-status"
                                            {{ $playStoreDownload['status'] == 1 ? 'checked' : '' }}
                                            data-modal-id="toggle-modal" data-toggle-id="play-store-download-status"
            ...
            <div class="row">
                    ...
                    <div class="card h-100">
                        <div class="card-header">
                            <h5 class="mb-0 d-flex align-items-center gap-2">
                                <img src="{{ dynamicAsset(path: 'public/assets/back-end/img/website-color.png') }}"
                                    alt="">
                        ...
                        <div class="card-body d-flex flex-wrap gap-4 justify-content-around">
                            <div class="form-group">
                                ...
                                <div class="text-center">
                                    <div class="title-color mb-4 mt-3">
                                        {{ strtoupper($businessSetting['primary_color']) }}</div>
                                    <label class="title-color text-capitalize">{{ translate('primary_Color') }}</label>
                                </div>
                            </div>
                            <div class="form-group">
                                <input type="color" name="secondary"
                                    value="{{ $businessSetting['secondary_color'] }}"
                                    class="form-control form-control_color">
                                <div class="text-center">
                                    <div class="title-color mb-4 mt-3">
                                        {{ strtoupper($businessSetting['secondary_color']) }}</div>
                            ...
                            @if (theme_root_path() == 'theme_aster')
                                <div class="form-group">
                                    ...
                                    <div class="text-center">
                                        <div class="title-color mb-4 mt-3">
                                            {{ $businessSetting['primary_color_light'] ?? '#CFDFFB' }}</div>
                                        <label
                    ...
                    <div class="card h-100">
                        <div class="card-header">
                            <h5 class="mb-0 text-capitalize d-flex align-items-center gap-2">
                                <img src="{{ dynamicAsset(path: 'public/assets/back-end/img/header-logo.png') }}"
                                    alt="">
                ...
                <div class="col-xxl-4 col-sm-6 mb-3">
                    <div class="card h-100">
                        <div class="card-header">
                            <h5 class="mb-0 text-capitalize d-flex align-items-center gap-2">
                                <img src="{{ dynamicAsset(path: 'public/assets/back-end/img/footer-logo.png') }}"
                                    alt="">
                        ...
                        <div class="card-body d-flex flex-column justify-content-around">
                            <div class="d-flex justify-content-center">
                                <img height="60" id="view-website-fav-icon"
                                    src="{{ getStorageImages(path: $businessSetting['fav_icon'], type: 'backend-basic') }}"
                                    alt="">
                            </div>
                            <div class="position-relative mt-4">
                        ...
                        <div class="card-body d-flex flex-column justify-content-around">
                            <div class="d-flex justify-content-center">
                                <img height="60" id="view-loader-icon"
                                    src="{{ getStorageImages(path: $businessSetting['loader_gif'], type: 'backend-basic') }}"
                                    alt="">
                            </div>
                            <div class="position-relative mt-4">
                        ...
                        <div class="card-body d-flex flex-column justify-content-around">
                            <div class="d-flex justify-content-center">
                                <img height="60" id="view-app-logo"
                                    src="{{ getStorageImages(path: $businessSetting['mob_logo'], type: 'backend-basic') }}"
                                    alt="">
                            </div>
                            <div class="mt-4 position-relative">
...
@push('script')
    ...
    @endif
    <script
        src="{{ dynamicAsset(path: 'public/assets/back-end/js/admin/business-setting/maintenance-mode-setting.js') }}">
    </script>
    <script src="{{ dynamicAsset(path: 'public/assets/back-end/js/admin/business-setting/business-setting.js') }}">
    </script>
@endpush

...
@push('css_or_js')
    <link rel="stylesheet" href="{{ asset('assets/front-end/plugin/intl-tel-input/css/intlTelInput.css') }}">
@endpush
                                ...
                                @foreach ($web_config['customer_social_login_options'] as $socialLoginServiceKey => $socialLoginService)
                                    @if ($socialLoginService && $socialLoginServiceKey != 'apple')
                                        <a class="d-block" href="{{ route('customer.auth.service-login', $socialLoginServiceKey) }}">
                                            <img src="{{asset('assets/front-end/img/icons/'.$socialLoginServiceKey.'.png') }}" alt="{{ translate($socialLoginServiceKey) }}">
                                        </a>
                                    @endif
                                @endforeach
                            @endif

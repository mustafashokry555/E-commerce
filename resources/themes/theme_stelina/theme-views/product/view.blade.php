...
@section('content')
                ...
                <div class="card mb-3">
                    <div class="card-body">
                        <div class="row gy-2 align-items-center">
                            <div class="col-lg-4">
                                <h3 class="mb-1">{{ translate(str_replace(['-', '_', '/'], ' ', $data['offer_type'])) }}
                                    ...
                                    <div class="border rounded custom-ps-3 py-2">
                                        <div class="d-flex gap-2">
                                            <div class="flex-middle gap-2">
                                                ...
                                                <span class="d-none d-sm-inline-block">{{ translate('sort_by') . ':' }}
                                                </span>
                                            </div>
                                            <div class="dropdown product-view-sort-by">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end" id="sort-by-list">
                                                    <li class="link-hover-base product-list-filter-on-sort-by selected"
                                                        data-value="latest">
                                                        {{ translate('default') }}
                                                    </li>

                                                    <li class="link-hover-base product-list-filter-on-sort-by"
                                                        data-value="high-low">
                                        ...
                                        <div class="d-flex gap-2">
                                            ...
                                            <div class="dropdown">
                                                <button type="button"
                                                    ...
                                                    data-bs-toggle="dropdown" aria-expanded="false">
                                                    {{ $data['data_from'] == 'best-selling' ||
                                                    $data['data_from'] == 'top-rated' ||
                                                    $data['data_from'] == 'featured_deal' ||
                                                    $data['data_from'] == 'latest' ||
                                                    $data['data_from'] == 'most-favorite' ||
                                                    $data['data_from'] == 'featured'
                                                        ? ucwords(str_replace(['-', '_', '/'], ' ', translate($data['data_from'])))
                                                        : translate('default') }}
                                                </button>
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li class="link-hover-base filter-on-product-filter-change {{ $data['data_from'] == '' ? 'selected' : '' }}"
                                                        data-value="">
                                                        {{ translate('default') }}
                                                    </li>
                                                    <li class="link-hover-base filter-on-product-filter-change {{ $data['data_from'] == 'latest' ? 'selected' : '' }}"
                                                        data-value="latest">
                                                        {{ translate('Latest_Products') }}
                                                    </li>
                                                    <li class="link-hover-base filter-on-product-filter-change {{ $data['data_from'] == 'best-selling' ? 'selected' : '' }}"
                                                        data-value="best-selling">
                                                        {{ translate('Best_Selling') }}
                                                    </li>
                                                    <li class="link-hover-base filter-on-product-filter-change {{ $data['data_from'] == 'top-rated' ? 'selected' : '' }}"
                                                        data-value="top-rated">
                                                        {{ translate('Top_Rated') }}
                                                    </li>
                                                    <li class="link-hover-base filter-on-product-filter-change {{ $data['data_from'] == 'most-favorite' ? 'selected' : '' }}"
                                                        data-value="most-favorite">
                                                        {{ translate('Most_Favorite') }}
                                                    </li>
                                                    <li class="link-hover-base filter-on-product-filter-change {{ $data['data_from'] == 'featured' ? 'selected' : '' }}"
                                                        data-value="featured">
                                                        {{ translate('featured') }}
                                                    </li>
                                                    @if ($web_config['featured_deals'])
                                                        <li class="link-hover-base filter-on-product-filter-change {{ $data['data_from'] == 'featured_deal' ? 'selected' : '' }}"
                                                            data-value="featured_deal">
                        ...
                        <div class="card-body d-flex flex-column gap-4">
                            <div>
                                ...
                                <section class="range-slider">
                                    ...
                                    <input name="rangeOne" value="0" min="0" max="100000000000"
                                        step="1" type="range" id="price_rangeMin">
                                    <input name="rangeTwo" value="800000" min="1" max="100000000000"
                                        step="1" type="range" id="price_rangeMax">
                                </section>
                            </div>
                                ...
                                <div>
                                    <div class="border rounded p-2">
                                        <div class="d-flex gap-2">
                                            <div class="flex-middle gap-2">
                                                <i class="bi bi-sort-up-alt"></i>
                                                <span class="d-none d-sm-inline-block">{{ translate('Product_Type') }}
                                                </span>
                                            </div>
                                            <div class="dropdown product_type_sorting">
                                                <button type="button"
                                                    class="border-0 bg-transparent dropdown-toggle text-dark p-0 custom-pe-3 filter-on-product-type-button"
                                                    data-bs-toggle="dropdown" aria-expanded="false">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end" id="sort-by-list"
                                                    style="">
                                                    <li class="link-hover-base selected filter-on-product-type-change cursor-pointer"
                                                        data-value="all">
                                                        {{ translate('All') }}
                                                    </li>
                                                    <li class="link-hover-base filter-on-product-type-change cursor-pointer"
                                                        data-value="physical">
                                                        {{ translate('physical') }}
                                                    </li>
                                                    <li class="link-hover-base filter-on-product-type-change cursor-pointer"
                                        ...
                                        @foreach ($categories as $category)
                                            <li>
                                                <div class="d-flex justify-content-between">
                                                    <a
                                                        href="{{ route('products', ['category_id' => $category['id'], 'data_from' => 'category', 'offer_type' => isset($data['offer_type']) ? $data['offer_type'] : '', 'page' => 1]) }}">{{ $category['name'] }}</a>
                                                    ...
                                                    <ul class="sub_menu">
                                                        @foreach ($category->childes as $child)
                                                            <li>
                                                                <div class="d-flex justify-content-between">
                                                                    <a
                                                                        href="{{ route('products', ['sub_category_id' => $child['id'], 'data_from' => 'category', 'offer_type' => isset($data['offer_type']) ? $data['offer_type'] : '', 'page' => 1]) }}">{{ $child['name'] }}</a>
                                                                        ...
                                                                        @foreach ($child->childes as $ch)
                                                                            <li>
                                                                                <label class="custom-checkbox">
                                                                                    <a
                                                                                        href="{{ route('products', ['sub_sub_category_id' => $ch['id'], 'data_from' => 'category', 'offer_type' => isset($data['offer_type']) ? $data['offer_type'] : '', 'page' => 1]) }}">{{ $ch['name'] }}</a>
                                                                                </label>
                                                                            </li>
                                                                        @endforeach
                                                                    </ul>
                                                    ...
                                                    <div class="flex-between-gap-3 align-items-center">
                                                        <label class="custom-checkbox w-75">
                                                            <a class="text-truncate"
                                                                href="{{ route('products', ['brand_id' => $brand['id'], 'data_from' => 'brand', 'offer_type' => isset($data['offer_type']) ? $data['offer_type'] : '', 'page' => 1]) }}">{{ $brand['name'] }}</a>
                                                        </label>
                                                        <span
                                            ...
                                            @foreach ($web_config['publishing_houses'] as $publishingHouseItem)
                                                <li>
                                                    <div class="flex-between-gap-3 align-items-center">
                                                        <label class="custom-checkbox">
                                                            <a
                                                                href="{{ route('products', ['publishing_house_id' => $publishingHouseItem['id'], 'product_type' => 'digital', 'offer_type' => isset($data['offer_type']) ? $data['offer_type'] : '', 'page' => 1]) }}">
                                            ...
                                            @foreach ($web_config['digital_product_authors'] as $productAuthor)
                                                <li>
                                                    <div class="flex-between-gap-3 align-items-center">
                                                        <label class="custom-checkbox">
                                                            <a
                                                                href="{{ route('products', ['author_id' => $productAuthor['id'], 'product_type' => 'digital', 'offer_type' => isset($data['offer_type']) ? $data['offer_type'] : '', 'page' => 1]) }}">
                                                                {{ $productAuthor['name'] }}
                                                            </a>
                                                        </label>
                                                        <span class="badge bg-badge rounded-pill text-dark ms-auto">
                            ...
                            <div id="ajax-review_partials">
                                @include('theme-views.partials._products_review_partials', [
                                    'ratings' => $ratings,
                                ])
                            </div>
                        </div>
    ...
    <span id="products-search-data-backup" data-page="{{ request('page') ?? 1 }}" data-url="{{ route('products') }}"
        data-id="{{ $data['id'] }}" data-brand="{{ $data['brand_id'] ?? '' }}"

{{-- @php
    print_r($categories[0]->icon_full_url['path']);
    return 0;
@endphp --}}
                    ...
                    <div class="slider-item style1">
                        <div class="slider-inner equal-element"
                            ...
                            <div class="slider-infor">
                                ...
                                @endif
                                <a href="{{ $banner->url }}" class="button btn-shop-the-look bgroud-style">Shop
                                    now</a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="stelina-tabs  default rows-space-40">
            <div class="container">
                <div class="tab-head">
                    <ul class="tab-link">
                        <li class="active">
                            <a data-toggle="tab" aria-expanded="true" href="#bestseller">{{ translate('Best_Selling')
                                }}</a>
                        </li>
                        <li class>
                            <a data-toggle="tab" aria-expanded="true" href="#new_arrivals">{{ translate('New Arrivals')
                                }}</a>
                        </li>
                        <li class>
                            <a data-toggle="tab" aria-expanded="true" href="#top-rated">{{ translate('Top_Rated') }}</a>
                        </li>
                    </ul>
                </div>
                                            ...
                                            <div class="group-info">
                                                <div class="stars-rating">
                                                    <div class="star-rating">
                                                        @for ($index = 1; $index <= 5; $index++) @if ($index <=(int)
                                                            $overallRating[0]) <i class="bi bi-star-fill"></i>
                                                            @elseif ($overallRating[0] != 0 && $index <= (int)
                                                                $overallRating[0] + 1.1 && $overallRating[0]> ((int)
                                                                $overallRating[0]))
                                                ...
                                                <div class="price">
                                                    @if (getProductPriceByType(product: $product, type: 'discount',
                                                    result: 'value') > 0)
                                                    <del class="product__old-price">{{
                                                        webCurrencyConverter($product->unit_price) }}</del>
                                                    @endif
                                                    <ins class="product__new-price">
                                                        {{ getProductPriceByType(product: $product, type:
                                                        'discounted_unit_price', result: 'string') }}
                                                    </ins>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="product-inner equal-element">
                                ...
                                <div class="product-info">
                                    ...
                                    <div class="group-info">
                                        <div class="stars-rating">
                                            <div class="star-rating">
                                                @for ($index = 1; $index <= 5; $index++) @if ($index <=(int)
                                                    $overallRating[0]) <i class="bi bi-star-fill"></i>
                                                    @elseif ($overallRating[0] != 0 && $index <= (int) $overallRating[0]
                                                        + 1.1 && $overallRating[0]> ((int) $overallRating[0]))
                                                        <i class="bi bi-star-half"></i>
                                                        @else
                                                        <i class="bi bi-star"></i>
                                                        @endif
                                        ...
                                        <div class="price">
                                            @if (getProductPriceByType(product: $product, type: 'discount', result:
                                            'value') > 0)
                                            <del class="product__old-price">{{
                                                webCurrencyConverter($product->unit_price) }}</del>
                                            @endif
                                    ...
                                    {{-- <div class="group-buttons">
                                        ...
                                        <button class="add_to_cart_button button" tabindex="0">Shop
                                            now</button>
                                    </div> --}}
        ...
        <div class="stelina-instagram">
            <div class="instagram owl-slick equal-container"
                ...
                <div class="item-instagram">
                    <a>
                        <img src="{{ theme_asset('assets/images/item-instagram-01.jpg') }}" alt="img">
                    </a>
                    <span class="text">
                ...
                <div class="item-instagram">
                    <a>
                        <img src="{{ theme_asset('assets/images/item-instagram-02.jpg') }}" alt="img">
                    </a>
                    <span class="text">
                        <i class="icon flaticon-photo-camera" aria-hidden="true"></i>
                    </span>
                ...
                <div class="item-instagram">
                    <a>
                        <img src="{{ theme_asset('assets/images/item-instagram-03.jpg') }}" alt="img">
                    </a>
                    <span class="text">
                        <i class="icon flaticon-photo-camera" aria-hidden="true"></i>
                    </span>
                ...
                <div class="item-instagram">
                    <a>
                        <img src="{{ theme_asset('assets/images/item-instagram-04.jpg') }}" alt="img">
                    </a>
                    <span class="text">
                        <i class="icon flaticon-photo-camera" aria-hidden="true"></i>
                    </span>
                ...
                <div class="item-instagram">
                    <a>
                        <img src="{{ theme_asset('assets/images/item-instagram-05.jpg') }}" alt="img">
                    </a>
                    <span class="text">
                        <i class="icon flaticon-photo-camera" aria-hidden="true"></i>
                    </span>

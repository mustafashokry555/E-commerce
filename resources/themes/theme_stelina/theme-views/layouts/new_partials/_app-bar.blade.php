...
<ul class="list-unstyled d-flex justify-content-around gap-3 mb-0 position-relative bg-white shadow-lg">
                ...
                <div class="position-relative">
                    <svg width="21" height="20" viewBox="0 0 21 20" fill="none"
                        ...
                        <g clip-path="url(#clip0_8487_6242)">
                            <path
                                d="M14.917 1.59766C13.9786 1.61225 13.0607 1.8742 12.2559 2.35705C11.4512 2.8399 10.7881 3.52655 10.3336 4.34766C9.87916 3.52655 9.21607 2.8399 8.41132 2.35705C7.60657 1.8742 6.68867 1.61225 5.75029 1.59766C4.25441 1.66265 2.84505 2.31703 1.83011 3.41785C0.815174 4.51867 0.277165 5.97643 0.333624 7.47266C0.333624 11.2618 4.32196 15.4002 7.66696 18.206C8.41381 18.8336 9.35809 19.1777 10.3336 19.1777C11.3092 19.1777 12.2534 18.8336 13.0003 18.206C16.3453 15.4002 20.3336 11.2618 20.3336 7.47266C20.3901 5.97643 19.8521 4.51867 18.8371 3.41785C17.8222 2.31703 16.4128 1.66265 14.917 1.59766ZM11.9295 16.931C11.4828 17.3071 10.9176 17.5134 10.3336 17.5134C9.74966 17.5134 9.18447 17.3071 8.73779 16.931C4.45612 13.3385 2.00029 9.89182 2.00029 7.47266C1.94332 6.41825 2.3056 5.3841 3.00809 4.59574C3.71059 3.80738 4.69632 3.32878 5.75029 3.26432C6.80426 3.32878 7.78999 3.80738 8.49249 4.59574C9.19499 5.3841 9.55726 6.41825 9.50029 7.47266C9.50029 7.69367 9.58809 7.90563 9.74437 8.06191C9.90065 8.21819 10.1126 8.30599 10.3336 8.30599C10.5546 8.30599 10.7666 8.21819 10.9229 8.06191C11.0792 7.90563 11.167 7.69367 11.167 7.47266C11.11 6.41825 11.4723 5.3841 12.1748 4.59574C12.8773 3.80738 13.863 3.32878 14.917 3.26432C15.9709 3.32878 16.9567 3.80738 17.6592 4.59574C18.3617 5.3841 18.7239 6.41825 18.667 7.47266C18.667 9.89182 16.2111 13.3385 11.9295 16.9277V16.931Z"
                                fill="currentColor" />
                        </g>
                        <defs>
    ...
    <li>
        <div class="dropup position-static">
            ...
            <ul class="dropdown-menu scrollY-60 z-n1 bs-dropdown-min-width--100" id="cart_dropdown">
                            ...
                            <div class="media gap-3">
                                ...
                                <div class="media-body">
                                    <h6 class="mb-1 {{ $product && $product->status == 0 ? 'blur-section' : '' }}">
                                        <a
                                            href="{{ $product && $product->status == 1 ? route('product', $cartItem['slug']) : 'javascript:' }}">{{ Str::limit($cartItem['name'], 30) }}</a>
                                    </h6>
                                    @if (!empty($cartItem['variant']))
                                        <div>
                                            <span class="fs-12">{{ translate('variant') }} :
                                        ...
                                        <div class="quantity">
                                            @if ($product && $product->status == 1)
                                                ...
                                                <span
                                                    ...
                                                    data-product-id="{{ $cartItem['product_id'] }}" data-value=-1
                                                    data-event="minus" data-prevent="true">

                                                    @if (
                                                        $getProductCurrentStock < $cartItem['quantity'] ||
                                                            $cartItem['quantity'] == ($product ? $product->minimum_order_qty : 1))
                                                ...
                                                <input type="text"
                                                    ...
                                                    data-current-stock="{{ $getProductCurrentStock }}" data-value=0
                                                    data-prevent="true">
                                                <span class="quantity__plus cart-quantity-update"
                                                    data-cart-id="{{ $cartItem['id'] }}"
                                                    data-product-id="{{ $cartItem['product_id'] }}" data-value=1
                                                    data-event="plus" data-prevent="true">
                                            ...
                                            @else
                                                <span
                                                    ...
                                                    data-cart-id="{{ $cartItem['id'] }}"
                                                    data-product-id="{{ $cartItem['product_id'] }}"
                                                    data-value="-{{ $cartItem['quantity'] }}" data-event="minus"
                                                    data-prevent="true">
                                                    <i class="bi bi-trash3-fill text-danger fs-10"></i>
                                                </span>
                                                <input type="text"
                                                    ...
                                                    data-cart-id="{{ $cartItem['id'] }}"
                                                    data-product-id="{{ $cartItem['product_id'] }}" data-value=0
                                                    data-prevent="true">
                                            @endif
                                        </div>
                                    </div>

...
<span id="get-check-password-msg" data-retype="{{ translate('please_retype_password') }}"
...
<span id="get-resend-otp-text" data-success="{{ translate('OTP_has_been_sent_again.') }}"
    data-error="{{ translate('please_wait_for_new_code.') }}"></span>

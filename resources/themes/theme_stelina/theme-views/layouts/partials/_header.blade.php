                                ...
                                <div class="border-end">
                                    <div class="dropdown search_dropdown">
                                        ...
                                        <input type="hidden" name="search_category_value" id="search_category_value"
                                            value="{{ request('search_category_value') ?? 'all' }}">
                ...
                <div>
                    <div class="aside-body" data-trigger="scrollbar">
                        ...
                        <ul class="main-nav nav">
                                                    ...
                                                    <ul class="sub_menu">
                                                        @foreach ($category['childes'] as $subCategory)
                                                            <li>
                                                                <a href="javascript:">
                                                                    <span class="get-view-by-onclick"
                                                                        data-link="{{ route('products', ['category_id' => $subCategory['id'], 'data_from' => 'category', 'page' => 1]) }}">{{ $subCategory['name'] }}</span>
                                                                </a>
                                                                @if ($subCategory->childes->count() > 0)
                                                                    <ul class="sub_menu">
                                                                        @foreach ($subCategory['childes'] as $subSubCategory)
                                                                            <li>
                                                                                <a
                                                                                    href="{{ route('products', ['category_id' => $subSubCategory['id'], 'data_from' => 'category', 'page' => 1]) }}">
                                                                                    {{ $subSubCategory['name'] }}
                                                                                </a>
                                                                            </li>
                                                                        @endforeach
                            ...
                            @if (
                                $web_config['featured_deals']->count() > 0 ||
                                    ...
                                    <ul class="sub_menu">
                                        ...
                                        @foreach ($brands as $brand)
                                            ...
                                            @if ($brandIndex < 10)
                                                <li>
                                                    <a
                                                        href="{{ route('products', ['brand_id' => $brand['id'], 'data_from' => 'brand', 'page' => 1]) }}">{{ $brand->name }}</a>
                                                </li>
                                            @endif
                                        @endforeach
                                        <li>
                        ...
                        <li class="login-register d-flex align-items-center gap-4">
                            ...
                            <div class="profile-dropdown">
                                <button type="button"
                                    ...
                                    data-bs-toggle="dropdown" aria-expanded="false">
                                    <span
                                        class="avatar overflow-hidden header-avatar rounded-circle size-1-5rem border border-primary p-2px">
                                        @php($profileImg = getCustomerFromQuery() ? getCustomerFromQuery()->image_full_url : '')
                                        <img loading="lazy" class="img-fit rounded-circle"
                                            alt="{{ translate('image') }}"

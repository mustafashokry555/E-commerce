...
if (!function_exists('getStorageImages')) {
    function getStorageImages($path, $type = null, $source = null): string
    {
        ...
        $placeholderMap = [
            ...
            'product' => [
                'theme_stelina' => 'assets/img/placeholder/placeholder-1-1.png',
            ...
            'avatar' => [
                'theme_stelina' => 'assets/img/placeholder/user.png',
            ...
            'banner' => [
                ...
                'theme_stelina' => 'assets/img/placeholder/placeholder-2-1.png',
            ...
            'wide-banner' => [
                'theme_stelina' => 'assets/img/placeholder/placeholder-4-1.png',
            ...
            'shop' => [
                'theme_stelina' => 'assets/img/placeholder/shop.png',
